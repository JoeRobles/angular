(function() {
  ...
  var moduleName = 'app',
    ...
    paths = {
      html: 'src/**/*.html',
      libScripts: ['src/**/*module.js', 'src/**/*.js', '!src/**/tests/*.js'], // ignore tests dir
      testsDest: 'tests',
      testsOrig: 'src/**/tests/*.js',
      js: ['src/**/*module.js', 'src/**/*.js'],
      less: 'src/**/*.less',
      dest: 'dist',
      livereload: ['dist/**/*.*', 'index.html', '!dist/**/tests/*.js'],
      templatesPrefix: 'src/'
    };
